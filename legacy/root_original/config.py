...
class Config:
    ...
    SAVE_DIR = "/root/autodl-tmp/SNN/整合完整/整合分类/zhengheA2_2/checkpoints"
    ...
    RESUME_CHECKPOINT_PATH = "/root/autodl-tmp/SNN/整合完整/整合分类/zhengheA2_2/checkpoints/latest_checkpoint.pth"
    ...
    RECONSTRUCTION_CONFIG = {
        ...
        'soft_reset': True,
        # 'ablation_mode': 'dual'
        # 'ablation_mode': 'local_only' #保留空域分支
        'ablation_mode': 'global_only' #保留频域分支
    }

...
class Config:
    ...
    LR_DIR = "/root/autodl-tmp/SNN/整合完整/整合分类/datasets/UFO120/UFO120/train_val/LR_x4"
    # REF_HR_DIR = "autodl-tmp/SNN/整合完整/整合分类/datasets/USR-248/hr"
    SAVE_DIR = "/root/autodl-tmp/SNN/整合完整/整合分类/uieb/zhenghe_x2/checkpoints"
    
    # 验证集路径
    VAL_HR_DIR = "/root/autodl-tmp/SNN/整合完整/整合分类/datasets/reference-890"
    VAL_LR_DIR = "/root/autodl-tmp/SNN/整合完整/整合分类/datasets/raw-890"
    ...
    RESUME_CHECKPOINT_PATH = "/root/autodl-tmp/SNN/整合完整/整合分类/uieb/zhenghe_x2/checkpoints/latest_checkpoint.pth"

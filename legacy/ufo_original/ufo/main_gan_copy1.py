...
from utils import set_seed, ParameterMonitor, save_metrics_to_csv, \
...
system = JointTrainingSystem(device='cpu')
print(system.reconstruction_module.reconstruction_net.upsampling_path)

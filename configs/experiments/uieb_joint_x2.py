...
PATHS = PathConfig(
    train_hr_dir="data/UIEB/train/hr",
    train_lr_dir="data/UIEB/train/lr_x2",
    ref_hr_dir="data/UIEB/train/ref_hr",
    val_hr_dir="data/UIEB/val/hr",
    val_lr_dir="data/UIEB/val/lr_x2",
    save_dir="outputs/uieb_joint_x2",
    niqe_prior_path="outputs/uieb_joint_x2/niqe_water_params.mat",
...
CONFIG = ExperimentConfig(
    name="uieb_joint_x2",
    description="Joint training template for the UIEB dataset at x2 scale.",
    mode="joint",
    paths=PATHS,
